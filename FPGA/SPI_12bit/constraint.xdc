...
##Switches
set_property -dict {PACKAGE_PIN G15 IOSTANDARD LVCMOS33} [get_ports i_Rst_L_]
...
##Buttons
set_property -dict {PACKAGE_PIN K18 IOSTANDARD LVCMOS33} [get_ports i_TX_DV_]
...
##Pmod Header JE
set_property -dict {PACKAGE_PIN V12 IOSTANDARD LVCMOS33} [get_ports o_SPI_MOSI_]
set_property -dict {PACKAGE_PIN W16 IOSTANDARD LVCMOS33} [get_ports i_SPI_MISO_]
set_property -dict {PACKAGE_PIN J15 IOSTANDARD LVCMOS33} [get_ports o_SPI_Clk_]
set_property -dict {PACKAGE_PIN H15 IOSTANDARD LVCMOS33} [get_ports o_RX_DV_]
set_property -dict {PACKAGE_PIN V13 IOSTANDARD LVCMOS33} [get_ports o_TX_Ready_]
set_property -dict {PACKAGE_PIN U17 IOSTANDARD LVCMOS33} [get_ports clk_SPI]
...
connect_debug_port u_ila_0/clk [get_nets [list instance1/inst/clk_ILA]]
set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_0/probe0]
set_property port_width 1 [get_debug_ports u_ila_0/probe0]
connect_debug_port u_ila_0/probe0 [get_nets [list clk_SPI_OBUF]]
create_debug_port u_ila_0 probe
set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_0/probe1]
set_property port_width 1 [get_debug_ports u_ila_0/probe1]
connect_debug_port u_ila_0/probe1 [get_nets [list o_SPI_Clk__OBUF]]
create_debug_port u_ila_0 probe
set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_0/probe2]
set_property port_width 1 [get_debug_ports u_ila_0/probe2]
connect_debug_port u_ila_0/probe2 [get_nets [list o_SPI_MOSI__OBUF]]
