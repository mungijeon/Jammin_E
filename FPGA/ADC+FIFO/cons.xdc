...
set_property -dict {PACKAGE_PIN T10 IOSTANDARD LVCMOS33} [get_ports {dataout[11]}]
#set_property -dict { PACKAGE_PIN W14   IOSTANDARD LVCMOS33     } [get_ports {sawtooth_[12]}]; #IO_L8P_T1_34 Sch=jc_p[3]
#set_property -dict { PACKAGE_PIN Y14   IOSTANDARD LVCMOS33     } [get_ports {sawtooth_[13]}]; #IO_L8N_T1_34 Sch=jc_n[3]
#set_property -dict { PACKAGE_PIN T12   IOSTANDARD LVCMOS33     } [get_ports {]; #IO_L2P_T0_34 Sch=jc_p[4]
...
set_property -dict {PACKAGE_PIN V18 IOSTANDARD LVCMOS33} [get_ports clk_test]
...
set_property DONT_TOUCH true [get_nets rden_i]
...
connect_debug_port u_ila_0/clk [get_nets [list instance_name/inst/clk_test]]
set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_0/probe0]
set_property port_width 12 [get_debug_ports u_ila_0/probe0]
connect_debug_port u_ila_0/probe0 [get_nets [list {debug_dataout[0]} {debug_dataout[1]} {debug_dataout[2]} {debug_dataout[3]} {debug_dataout[4]} {debug_dataout[5]} {debug_dataout[6]} {debug_dataout[7]} {debug_dataout[8]} {debug_dataout[9]} {debug_dataout[10]} {debug_dataout[11]}]]
create_debug_port u_ila_0 probe
set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_0/probe1]
set_property port_width 9 [get_debug_ports u_ila_0/probe1]
connect_debug_port u_ila_0/probe1 [get_nets [list {f1/rdptr[0]} {f1/rdptr[1]} {f1/rdptr[2]} {f1/rdptr[3]} {f1/rdptr[4]} {f1/rdptr[5]} {f1/rdptr[6]} {f1/rdptr[7]} {f1/rdptr[8]}]]
create_debug_port u_ila_0 probe
set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_0/probe2]
set_property port_width 9 [get_debug_ports u_ila_0/probe2]
connect_debug_port u_ila_0/probe2 [get_nets [list {f1/wrptr[0]} {f1/wrptr[1]} {f1/wrptr[2]} {f1/wrptr[3]} {f1/wrptr[4]} {f1/wrptr[5]} {f1/wrptr[6]} {f1/wrptr[7]} {f1/wrptr[8]}]]
create_debug_port u_ila_0 probe
set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_0/probe3]
set_property port_width 12 [get_debug_ports u_ila_0/probe3]
connect_debug_port u_ila_0/probe3 [get_nets [list {debug_datain[0]} {debug_datain[1]} {debug_datain[2]} {debug_datain[3]} {debug_datain[4]} {debug_datain[5]} {debug_datain[6]} {debug_datain[7]} {debug_datain[8]} {debug_datain[9]} {debug_datain[10]} {debug_datain[11]}]]
create_debug_port u_ila_0 probe
...
connect_debug_port dbg_hub/clk [get_nets clk_test_OBUF]
